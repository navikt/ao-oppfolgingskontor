CREATE TABLE failed_messages (
                                 ...
                                 message_key VARCHAR(255) NOT NULL,           -- Nøkkelen fra Kafka-meldingen
...
CREATE INDEX idx_failed_messages_key_timestamp ON failed_messages (message_key, queue_timestamp);